...
<div id="main">
    ...
    <c:forEach var="item" items="${employeeslist}" varStatus="listStatus">
        <div class="col-div-3">
    ...
    <c:forEach var="item2" items="${driverslist}" varStatus="listStatus">
        <div class="col-div-3">
            <div class="accordion-header">
                <button class="btn btn-link" type="button" data-bs-toggle="collapse" data-bs-target="#collapse${listStatus.index}" aria-expanded="true" aria-controls="collapse${listStatus.index}">
                    <div class="row">
                        <div class="col-2 text-start">
                            <p class="list-header">Id</p>
                            <p class="list">${item2.id}</p>
                        </div>
                        <div class="col-2 text-center">
                            <p class="list-header">Nazwa użytkownika</p>
                            <p class="list">${item2.username} </p>
                        </div>
                        <div class="col-2 text-center">
                            <p class="list-header">Imię</p>
                            <p class="list">${item2.name}</p>
                        </div>
                        <div class="col-2 text-center">
                            <p class="list-header">Nazwisko</p>
                            <p class="list">${item2.surname}</p>
                        </div>
                        <div class="col-2 text-center">
                            <p class="list-header">Email</p>
                            <p class="list">${item2.email}</p>
                        </div>
                        <div class="col-2 text-end">
                            <p class="list-header">Stanowisko</p>
                            <p class="list">${item2.role}</p>
                        </div>
