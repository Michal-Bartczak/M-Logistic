        ...
        <div class="col-div-3">
                ...
                <button class="btn btn-link" type="button" data-bs-toggle="collapse" data-bs-target="#collapse${listStatus.index}" aria-expanded="true" aria-controls="collapse${listStatus.index}">
                    <div class="row">
                        ...
                        <div class="col-3 text-center">
                            ...
                            <p class="list">${order.nameRecipient}, ${order.cityRecipient}, ${order.streetRecipient}</p>
                        </div>
                        <div class="col-3 text-center">
            ...
            <div id="collapse${listStatus.index}" class="collapse" data-bs-parent="#accordionExample">
                <div class="box row">
                    ...
                    <div class="col-2">${order.price} zł</div>
                    <div class="col-2">${order.zipCodeRecipient}</div>
                    <div class="col-2">${order.weigh}</div>
                    <div class="col-2"><a href="#" class="link-details">List przewozowy</a></div>
                    <div class="col-2"><a href="#"class="link-details">Etykieta</a></div>
                </div>
            </div>
